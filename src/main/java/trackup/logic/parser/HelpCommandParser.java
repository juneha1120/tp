...
public class HelpCommandParser implements Parser<HelpCommand> {
    ...
    public HelpCommand parse(String args) throws ParseException {
        ...
        case AddEventCommand.COMMAND_WORD -> new HelpCommand(AddEventCommand.COMMAND_WORD, AddEventCommand.MESSAGE_USAGE,
                "Adds an event to TrackUp's calendar.");
        case ClearCommand.COMMAND_WORD -> new HelpCommand(ClearCommand.COMMAND_WORD, ClearCommand.COMMAND_WORD,
                "Adds a contact to TrackUp.");
        ...
        case DeleteByCommand.COMMAND_WORD -> new HelpCommand(DeleteByCommand.COMMAND_WORD, DeleteByCommand.MESSAGE_USAGE,
                "Deletes a contact from TrackUp using one or more attributes.");
        case DeleteEventCommand.COMMAND_WORD -> new HelpCommand(DeleteEventCommand.COMMAND_WORD, DeleteEventCommand.MESSAGE_USAGE,
                "Deletes events from TrackUp's calendar based on specified filters.");
        case EditCommand.COMMAND_WORD -> new HelpCommand(EditCommand.COMMAND_WORD, EditCommand.MESSAGE_USAGE,
                "Edits an existing person in TrackUp.");
        case ExitCommand.COMMAND_WORD -> new HelpCommand(ExitCommand.COMMAND_WORD, ExitCommand.COMMAND_WORD,
                "Exits TrackUp.");
        case FindCommand.COMMAND_WORD -> new HelpCommand(FindCommand.COMMAND_WORD, FindCommand.MESSAGE_USAGE,
        ...
        case SearchCommand.COMMAND_WORD -> new HelpCommand(SearchCommand.COMMAND_WORD, SearchCommand.MESSAGE_USAGE,
                "Finds persons whose attributes contain the specified keyword");
        case SortCommand.COMMAND_WORD -> new HelpCommand(SortCommand.COMMAND_WORD, SortCommand.MESSAGE_USAGE,
